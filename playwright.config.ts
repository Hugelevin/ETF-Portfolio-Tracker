...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "mobile", use: { ...devices["Pixel 7"] } },
    {
      name: "ios-webkit",
      fullyParallel: false,
      grep: /does not draw black chart boxes|does not overflow on the narrowest supported phone|keeps the purchase date aligned on tablet|keeps edit order form within the phone viewport|uses consistent full-screen mobile modals/,
