...
export function HoldingsTable({ positions, loading, errors, onSelect, onDelete }: Props) {
  return <section className="holdings-section" aria-labelledby="holdings-title">
    ...
    <div className="table-shell">
      <table>
        <thead><tr><th scope="col">Instrument</th><th scope="col">Shares / units</th><th scope="col">Latest</th><th scope="col">Invested</th><th scope="col">Value</th><th scope="col">Return</th><th scope="col"><span className="sr-only">Actions</span></th></tr></thead>
