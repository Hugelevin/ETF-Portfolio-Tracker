...
import { buildPositionValueHistory } from "../domain/portfolio";
    ...
    <div className="chart" role="img" aria-label={`Historical market value chart with ${data.length} data points`}>
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={data} margin={{ top: 10, right: 12, left: 0, bottom: 0 }}>
          ...
          <YAxis tickFormatter={(value: number) => new Intl.NumberFormat("en-GB", { notation: "compact" }).format(value)} tickLine={false} axisLine={false} width={52} />
